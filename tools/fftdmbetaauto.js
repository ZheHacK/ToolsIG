...
console.log(chalk`{bold.red   •                                                         •}`);
console.log(chalk`{bold.red   •  Ξ TITLE  : Folow Like Direct Message (Followers Target)•}`);
console.log(chalk`{bold.red   •  Ξ NOTE   : U can add more targets, use u best ratio!   •}`);
console.log(chalk`{bold.red   •                                                         •}`);
